...
const PackagesSection = () => {
  ...
  const packageOptions: PackageOption[] = [{
    ...
    features: ["10 foto aer  ee ad alta risoluzione", "1 video breve (30-60 secondi)", "Consegna entro 3 giorni lavorativi", "1 revisione inclusa"],
    ...
    features: ["20 foto aeree professionali", "Video con editing professionale (2-3 minuti)", "Color grading e correzioni avanzate", "Licenza commerciale inclusa", "Consegna entro 5 giorni lavorativi", "2 revisioni incluse"],
  ...
  return <section id="packages" className="section-padding bg-neutral-900">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="drone-subheading mb-2 animate-on-scroll">I Nostri <span className="text-drone-orange">Pacchetti</span></h2>
